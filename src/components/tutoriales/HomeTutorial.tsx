...
// 🎯 Configuración de pasos del tutorial para HOME
const TUTORIAL_STEPS = [
  {
    id: 'welcome',
    target: null,
    title: 'Welcome to Your Campus! 🎓',
    description: 'This is your main dashboard, where you’ll see all the important information about your courses, progress, and activities.',
    position: 'center',
    highlight: false,
  },
  {
    ...
    description: 'Here you can see your active courses, earned certificates, study language, and current level.',
    position: 'bottom',
    highlight: true,
  },
  {
    id: 'quick-access',
    target: 'quick-access-card',
    title: 'Quick Access ⚡',
    description: 'These cards let you quickly navigate to the most important sections of the campus.',
    position: 'top',
    highlight: true,
  },
  {
    ...
    description: 'Stay up to date with the latest news and messages from your instructors.',
    position: 'top',
    highlight: true,
  },
  {
    ...
    description: 'Review your latest actions on the campus, such as completed games and viewed materials.',
    position: 'top',
    highlight: true,
  },
  {
    ...
    target: null,
    title: 'All Set! 🎉',
    description: 'You now know your main dashboard. Start exploring your campus and enjoy learning!',
    position: 'center',
    highlight: false,
  },
];
...
export default function HomeTutorial() {
  ...
  const updateHighlight = React.useCallback(() => {
    ...
    if (element) {
      ...
      // Si no encuentra el elemento, igual muestra el tooltip centrado
      setHighlightRect(null);
    }
