      ...
      return (
        <div className="space-y-3">
          ...
          <textarea
            ...
            placeholder="Escribe la descripción... Los saltos de línea se respetan tal cual"
            value={block.value}
            onChange={(e) => onChange({ ...block, value: e.target.value })}
          ...
          <div className="border rounded p-3 bg-slate-50">
            ...
            <MarkdownWYSIWYG>
              {block.value || "*Escribe para ver la vista previa...*"}
            </MarkdownWYSIWYG>
          </div>
      ...
      return (
        <div className="space-y-3">
          ...
          <textarea
            rows={8}
            className="w-full border rounded px-3 py-2 font-mono"
            placeholder="Escribe teoría... Los saltos de línea se respetan tal cual"
            value={block.value}
            onChange={(e) => onChange({ ...block, value: e.target.value })}
            style={{ whiteSpace: "pre-wrap" }}
          />
          ...
          <div className="border rounded p-3 bg-slate-50">
            ...
            <MarkdownWYSIWYG>
              {block.value || "*Escribe teoría para ver la vista previa...*"}
            </MarkdownWYSIWYG>
          </div>
