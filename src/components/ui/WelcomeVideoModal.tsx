...
export default function WelcomeVideoModal({
  ...
  return (
  <div
    className={`fixed inset-0 z-[99999] flex items-center justify-center p-3 md:p-4 transition-opacity duration-200 ${
    ...
    >
      ...
      >
        <div className="flex items-center gap-3 md:gap-4">
          ...
          >
            {/* Icono ajustado */}
            <PlayCircle className="w-5 h-5 md:w-7 md:h-7 text-white" strokeWidth={2.5} />
          </div>
          <div>
            {/* Título y subtítulo ajustados */}
            <h2 className="text-lg md:text-2xl font-bold text-white flex items-center gap-2 leading-tight">
              Welcome to the Virtual Campus!
              <Sparkles className="w-4 h-4 md:w-5 md:h-5 text-yellow-300 shrink-0" />
            </h2>
